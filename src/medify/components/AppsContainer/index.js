...
// import { useLayoutContext } from "../../context/AppContextProvider/LayoutContextProvider";
import {
  StyledAppContainer,
  StyledAppWrap,
  StyledAppWrapHeader,
...
const AppsContainer = (props) => {
  ...
  // if (layoutContext && layoutContext.footer) {
  //   const { footer } = layoutContext();
  //   // Now you can use the footer property
  // } else {
  //   console.log("Handle the case when layoutContext or footer is null");
  // }
