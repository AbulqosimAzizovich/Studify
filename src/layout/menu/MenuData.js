const menu = [
  ...
  {
    icon: "speed",
    text: "Управления сервисами",
    link: "/sales",
    dashboard: true,
  },
  {
    icon: "coins",
    text: "Управления платежами",
    link: "/crypto",
    dashboard: true,
  },
  {
    icon: "view-col",
    text: "Управления Больницой",
    link: "/invest",
    dashboard: true,
  },
  {
    heading: "Корпоративные приложения",
  },
