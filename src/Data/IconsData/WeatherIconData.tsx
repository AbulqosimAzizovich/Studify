...
import { WeatherIconType } from '../../Types/IconsType';

export const weatherIconData: WeatherIconType[] = [
    
    {
        icon: <svg className="climacon climacon_sun" id="sun" version="1.1" viewBox="15 15 70 70">
