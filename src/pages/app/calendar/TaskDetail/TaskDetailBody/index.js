...
import AppIconButton from "../../../../../medify/components/AppIconButton";
import {
  StyledDetailContent,
  StyledTodoDetailBtn,
...
import {
  ...
  TaskCreatedByInfo,
  TaskLabels,
} from "../../../../../medify/modules/apps/Calendar";
import { CalendarContext } from "../../../context/CalendarContextProvider";
import { getDateObject, getFormattedDate } from "../../../../../medify/helpers/DateHelper";

const TaskDetailBody = (props) => {
  const { selectedTask, onUpdateSelectedTask } = props;
  const infoViewActionsContext = useInfoViewActionsContext();
  const { staffList } = CalendarContext();
