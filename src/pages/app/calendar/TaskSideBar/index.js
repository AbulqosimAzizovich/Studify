...
import AppsSideBarFolderItem from "../../../../medify/components/AppsSideBarFolderItem";
import AppList from "../../../../medify/components/AppList";
import ListEmptyResult from "../../../../medify/components/AppList/ListEmptyResult";
import SidebarPlaceholder from "../../../../medify/components/AppSkeleton/SidebarListSkeleton";
import { FilterItem, TaskLabelItem } from "../../../../medify/modules/apps/Calendar";
...
const TaskSideBar = () => {
  const { labelList, folderList, priorityList, statusList, filterData } = CalendarContext();
  const { setFilterData } = CalendarActionsContext();
        ...
        <StyledTodoSidebarContent>
          ...
          <StyledTodoSidebarList aria-label="main mailbox folders">
            <AppList
              data={labelList}
              ListEmptyComponent={<ListEmptyResult loading={true} placeholder={<SidebarPlaceholder />} />}
              renderItem={(label) => <TaskLabelItem key={label.id} label={label} />}
            />
          </StyledTodoSidebarList>
